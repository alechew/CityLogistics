...
<table cellpadding="0" cellspacing="0" style="border: 1px solid #000;width: 100%;margin:0;padding:0;">
	...
	<tr style="border-top: 1px solid #000;border-bottom: 1px solid #000;">
		<td id="shipment-info" style="padding: 12px;vertical-align: initial;border-right: 1px solid #000;">
			...
			<p><span class="label"><?php _e('Type of Shipment', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_type_of_shipment', true ); ?></span></p>
			<p><span class="label"><?php _e('Courier', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_courier', true ); ?></span></p>
			<p><span class="label"><?php _e('Carrier Reference No.', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_carrier_ref_number', true ); ?></span></p>
			<p><span class="label"><?php _e('Mode', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_mode_field', true ); ?></span></p>
			<p><span class="label"><?php _e('Carrier', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_carrier_field', true ); ?></span></p>
			<p><span class="label"><?php _e('Packages', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_packages', true ); ?></span></p>
			<p><span class="label"><?php _e('Product', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_product', true ); ?></span></p>
			<p><span class="label"><?php _e('Weight', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_weight', true ); ?></span></p>
			<p><span class="label"><?php _e('Quantity', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_qty', true ); ?></span></p>
			<p><span class="label"><?php _e('Total Freight', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_total_freight', true ); ?></span></p>
			<p><span class="label"><?php _e('Payment Mode', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'payment_wpcargo_mode_field', true ); ?></span></p>
			<p><span class="label"><?php _e('Origin', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_origin_field', true ); ?></span></p>
			<p><span class="label"><?php _e('Pickup Date', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_pickup_date_picker', true ); ?></span></p>
			<p><span class="label"><?php _e('Destination', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_destination', true ); ?></span></p>
			<p><span class="label"><?php _e('Departure Time', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_departure_time_picker', true ); ?></span></p>
			<p><span class="label"><?php _e('Pickup Time', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_pickup_time_picker', true ); ?></span></p>
			<p><span class="label"><?php _e('Expected Delivery Date', 'wpcargo'); ?></span>:<br/><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_expected_delivery_date_picker', true ); ?></span></p>
					...
					<tr style="padding: 0;border-bottom: 1px solid #000; display: block;">
						<td style="width: 50%;padding:0;">
							<div id="sender-info" class="sender-section" >
								...
								<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_shipper_name', true ); ?></span></p>
								<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_shipper_phone', true ); ?></span></p>
								<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_shipper_address', true ); ?></span></p>
								<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_shipper_email', true ); ?></span></p>
							...
							<div id="sender-note" class="sender-section">
								...
								<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_comments', true ); ?></span></p>
							</div>
						</td>
					</tr>
					<tr style="padding: 0;">
						<td id="receiver-info">
							...
							<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_receiver_name', true ); ?></span></p>
							<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_receiver_phone', true ); ?></span></p>
							<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_receiver_address', true ); ?></span></p>
							<p><span class="data"><?php echo get_post_meta( $shipmentDetails['shipmentID'], 'wpcargo_receiver_email', true ); ?></span></p>
