...
<div id="print-shipment-info">
  ...
  <div class="col-4">
    ...
    <p class="label-info"><?php echo !empty($shipment_expected_delivery_date) ? date_i18n($wpc_date_format, strtotime($shipment_expected_delivery_date)) : ''; ?></p>
  </div>
  <div class="col-4">
    <p class="label">
  ...
  <div class="col-4">
    ...
    <p class="label-info"><?php echo !empty($shipment_pickup_date) ? date_i18n($wpc_date_format, strtotime($shipment_pickup_date)) : ''; ?></p>
  </div>
  <div class="col-4">
    <p class="label">
