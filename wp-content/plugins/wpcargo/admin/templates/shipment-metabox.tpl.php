  ...
  <table class="wpcargo form-table">
    ...
    <tr>
      ...
      <td>
        ...
        ?>
        <?php echo ( empty( $wpc_agents ) ) ? '<span class="meta-box error">'.__('No agents found, Please add Agents <a href="'.admin_url().'/user-new.php">Here</a> make sure the role assign is "WPCargo Agent".', $this->text_domain ).'</span>' : '' ; ?>
      </td>
    </tr>
    <tr>
      <th><label>
    ...
    <tr>
      ...
      <td>
        <input type='text' class="datepicker" id='datetimepicker3' name="wpcargo_expected_delivery_date_picker" autocomplete="off" value="<?php echo !empty($wpcargo_expected_delivery_date_picker) ? date_i18n("Y-m-d", strtotime($wpcargo_expected_delivery_date_picker)) : ''; ?>"/>
      </td>
    </tr>
    <tr>
      <th><label>
