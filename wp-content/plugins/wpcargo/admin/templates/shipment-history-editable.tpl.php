			...
			if( !empty( $shipments ) ):
				foreach ( $shipments as $shipment ) :
					...
					<tr data-repeater-item class="history-data">
						<td class="tbl-sh-date"><input class="datepicker" type="text" name="date" value="<?php echo !empty($shipment['date']) ? date_i18n("Y-m-d", strtotime($shipment['date'])) : ''; ?>"/></td>
						<td class="tbl-sh-time"><input class="timepicker" type="text" name="time" value="<?php echo $shipment['time']; ?>"/></td>
				...
				?>
				<tr data-repeater-item class="history-data">
					<td class="tbl-sh-date"><input class="datepicker" type="text" name="date" value=""/></td>
					<td class="tbl-sh-time"><input class="timepicker" type="text" name="time" value=""/></td>
