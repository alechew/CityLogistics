	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td>
				...
				<p style="font-size: 10px;">(          <?php _e( 'Check and Leave the Demo Notice blank if you want to display the Standard Demo Notice.', $this->text_domain ) ; ?>          )</p>
		...
		<tr>
			...
			<td>
				...
				<textarea placeholder="<?php _e( 'Ex. Shipment 1, Shipment 2, Shipment 3', $this->text_domain ) ; ?>" cols="40" rows="5" name="wpcargo_option_settings[settings_shipment_type]"><?php echo esc_attr( $options['settings_shipment_type'] ); ?></textarea>

				<p style="font-size: 10px;">(          <?php _e( 'Must be comma separated', $this->text_domain ) ; ?>          )</p>
		...
		<tr>
			...
			<td>
				...
				<textarea placeholder="<?php _e( 'Ex. Shipment Mode 1, Shipment Mode 2, Shipment Mode 3', $this->text_domain ) ; ?>" cols="40" rows="5" name="wpcargo_option_settings[settings_shipment_wpcargo_mode]"><?php echo esc_attr( $options['settings_shipment_wpcargo_mode'] ); ?></textarea>
				<p style="font-size: 10px;">(          <?php _e( 'Must be comma separated', $this->text_domain ) ; ?>          )</p>
		...
		<tr>
			...
			<td>
				...
				<textarea placeholder="<?php _e( 'Ex. Shipment Status 1, Shipment Status 2, Shipment Status 3', $this->text_domain ) ; ?>" cols="40" rows="5" name="wpcargo_option_settings[settings_shipment_status]"><?php echo esc_attr( $options['settings_shipment_status'] ); ?></textarea>
				<p style="font-size: 10px;">(          <?php _e( 'Must be comma separated', $this->text_domain ) ; ?>          )</p>
		...
		<tr>
			...
			<td>
				...
				<textarea placeholder="<?php _e( 'Ex. Afghanistan, Albania, Algeria', $this->text_domain ) ; ?>" cols="40" rows="5" name="wpcargo_option_settings[settings_shipment_country]"><?php echo esc_attr( $options['settings_shipment_country'] ); ?></textarea>
		...
		<tr>
			...
			<td>
				...
				<textarea placeholder="<?php _e( 'Ex. Shipment Carrier 1, Shipment Carrier 2, Shipment Carrier 3', $this->text_domain ) ; ?>" cols="40" rows="5" name="wpcargo_option_settings[settings_shipment_wpcargo_carrier]"><?php echo esc_attr( $options['settings_shipment_wpcargo_carrier'] ); ?></textarea>
				<p style="font-size: 10px;">(          <?php _e( 'Must be comma separated', $this->text_domain ) ; ?>          )</p>
		...
		<tr>
			...
			<td>
				...
				<textarea placeholder="<?php _e( 'Ex. Payment Mode 1, Payment Mode 2, Payment Mode 3', $this->text_domain ) ; ?>" cols="40" rows="5" name="wpcargo_option_settings[settings_shipment_wpcargo_payment_mode]"><?php echo esc_attr( $options['settings_shipment_wpcargo_payment_mode'] ); ?></textarea>
				<p style="font-size: 10px;">(          <?php _e( 'Must be comma separated', $this->text_domain ) ; ?>          )</p>
		...
		<tr valign="top">
			...
			<td>
				...
				<p style="font-size: 10px;">( <?php _e( 'Check if you want to display barcode at the results.', $this->text_domain ) ; ?> )</p>
        ...
        <tr>
        	<th scope="row"><?php _e( 'Enable WPCargo Autogenerate Title?', $this->text_domain ) ; ?></th>
        	<td>
        ...
        <tr>
        	...
        	<td>
        		...
        		<p><input type="text" name="wpcargo_option_settings[wpcargo_title_prefix]" value="<?php echo $options['wpcargo_title_prefix']; ?>" placeholder="wpcargo"/></p>

        	</td>
		</tr>
		<tr>
        	<th scope="row">
				<?php _e( 'WPCargo Title Number Digits', $this->text_domain ) ; ?>
			</th>
        	<td>
        ...
        <tr>
        	<th scope="row"><?php _e( 'WPCargo base color', $this->text_domain ) ; ?></th>
        	<td>
        ...
        <tr>
        	<th colspan="2"><h2><?php _e( 'Shipment History Settings', $this->text_domain ) ; ?></h2></th>
        </tr>
        <tr>
        	<th><?php _e( 'Display Shipment History in Invoice', $this->text_domain ) ; ?></th>
        	<td>
        ...
        <tr>
        	<th scope="row"><?php _e( 'Enable User Timezone', $this->text_domain ) ; ?></th>
        	<td>
        ...
        <tr>
        	<th><?php _e( 'Allow Roles to update shipment history', $this->text_domain ) ; ?></th>
        	<td>
