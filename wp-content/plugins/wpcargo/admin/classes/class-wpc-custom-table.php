...
function manage_default_wpcargo_columns( $column, $post_id ) {
	...
	switch( $column ) {
		...
		case 'wpcargo_shipper_name' :
			$shipper_name 	= apply_filters( 'wpc_shipper_name_table_data', 'wpcargo_shipper_name' );
		...
		case 'wpcargo_receiver_name' :
			$receiver_name 	= apply_filters( 'wpc_receiver_name_table_data', 'wpcargo_receiver_name' );
		...
		case 'wpcargo_actions' :
			echo '<a href="edit.php?post_type=wpcargo_shipment&page=wpcargo-print-layout&id='.get_the_ID().'" class="button button-secondary"><span class="ti-printer"></span> Invoice</a><br/>';
			echo '<a href="edit.php?post_type=wpcargo_shipment&page=wpcargo-print-label&id='.get_the_ID().'" class="button button-secondary"><span class="ti-printer"></span> Label</a>';
		break;
		default :
			break;
	}
		 	...
		 	<fieldset id="shipment-bulk-update" class="inline-edit-col-left" style="border: 1px solid #ddd; margin-top: 6px; padding:8px;">
		 		<div class="inline-edit-col wpc-status-section">
					<div class="inline-edit-group wp-clearfix">
						...
						<p><input style="width:100%;" class="bulkdate" type="text" name="status_date" placeholder="<?php _e( 'yyyy-mm-dd', 'wpcargo' ); ?>"/></p>
						<p><input style="width:100%;" class="bulktime" type="text" name="status_time" /></p>
